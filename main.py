...
names = ["Flafi", "Falafel", "Witcher", "Lutik", "Pucheglas", "Slime", "Shust", "Sledopit",
         "Baby", "Subaru", "T-Rex", "Bird", "Private", "Erfahren", "Veteran", "Gamer",
         "Samuraj", "Stranger"]
generation = 0
...
def run_game(genomes, config):
    ...
    while True:
        ...
        # display generation
        label = heading_font.render("Evolution: " + str(generation), True, (0, 72, 186))
